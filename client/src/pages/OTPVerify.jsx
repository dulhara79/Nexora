...
const OTPVerify = () => {
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const formData = new URLSearchParams();
      formData.append("email", email);
      // Note: Backend requires password for /login, so this assumes it's stored or re-entered elsewhere
      // For simplicity, we'll assume it's handled in the Login component
