  ...
  return (
    <div className="min-h-screen px-4 py-12 bg-gradient-to-br from-amber-50 to-orange-100">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h1 className="mb-4 text-4xl font-bold text-gray-800">Your Questions</h1>
        ...
        {!loading && filteredQuestions.length === 0 && (
          ...
          >
            ...
            <h3 className="mb-2 text-xl font-medium text-gray-700">No questions found</h3>
            <p className="mb-6 text-gray-500">You haven't asked any questions yet</p>
            <Link 
              to="/forum/ask"
