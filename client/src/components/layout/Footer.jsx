  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              A platform where enthusiasts can share their skills, create learning plans, and connect with a community of passionate learners.
            </p>
          ...
          {footerLinks.map((group, groupIndex) => (
            ...
            >
              <h3 className="text-lg font-semibold mb-6 text-indigo-400">{group.title}</h3>
              <ul className="space-y-4">
                {group.links.map((link, linkIndex) => (
                  <motion.li 
                    ...
                    transition={{ delay: 0.2 + (groupIndex * 0.1) + (linkIndex * 0.05), duration: 0.3 }}
                  >
                    <Link
                      to={link.path}
                      className="text-gray-400 hover:text-white transition-colors duration-200"
        ...
        >
          <p>Made with ❤️ by SLIIT Students</p>
        </motion.div>
      </div>
    </motion.footer>
  );
