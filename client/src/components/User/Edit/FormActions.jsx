...
const FormActions = ({ loading, navigate, isDarkMode, hasChanges = true, onSave }) => {
  ...
  const btnShadow = isDarkMode ? 'shadow-lg shadow-blue-900/30' : 'shadow-lg shadow-blue-500/20';
    ...
    >
      ...
      <div className="flex items-center space-x-3">
        ...
        <motion.button
          type="submit"
          onClick={handleSave}
          className={`relative flex items-center px-5 py-2.5 text-white font-medium rounded-lg transition-all duration-300 ${primaryBtnBg} ${btnShadow} ${!hasChanges || loading ? 'opacity-70 cursor-not-allowed' : ''}`}
        ...
        >
          ...
          {/* Success indicator that appears and fades */}
          <AnimatePresence>
            {saveSuccess && (
              <motion.div 
