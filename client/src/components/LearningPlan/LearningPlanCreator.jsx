  ...
  const levels = [
    {
      name: 'Beginner',
      // greeting: 'Hi Beginner Cook',
      icon: <FaSeedling className="text-6xl text-blue-400 mb-4 animate-pulse drop-shadow-md" />,
      // gradient: 'from-blue-100 to-blue-50',
      borderColor: 'border-l-8 border-blue-400',
      textColor: 'text-blue-800',
      statement: '“I’ve never cooked before, but I’m curious to learn how to cook!”',
    },
    {
      name: 'Intermediate',
      // greeting: 'Hey Intermediate Chef',
      icon: <FaUtensils className="text-6xl text-yellow-400 mb-4 animate-pulse drop-shadow-md" />,
    ...
    },
    {
      name: 'Advanced',
      // greeting: 'Hello Advanced Master',
      icon: <FaCrown className="text-6xl text-red-400 mb-4 animate-pulse drop-shadow-md" />,
      // gradient: 'from-red-100 to-red-10',
      borderColor: 'border-l-8 border-red-400',
      textColor: 'text-red-800',
      statement: '“Cooking is my art and my passion- I want to master it.”',
    },
  ];
